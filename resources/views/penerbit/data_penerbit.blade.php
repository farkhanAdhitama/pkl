          ...
          <div class="row">
            <div class="col-12 grid-margin">
              <div class="float">
                ...
                <button type="button" data-bs-toggle="modal" data-bs-target="#insertDataPenerbit" class="btn btn-sm btn-primary mb-3"><i class="mdi mdi-library-plus mdi-icon"></i>Tambah Penerbit</button>
              <!-- The Insert Modal -->
                ...
                <div class="modal-dialog modal-dialog-centered">
                  <div class="modal-content">
                    ...
                    <div class="modal-body px-4">
                      <form action="/insertPenerbit" method="POST" enctype="multipart/form-data" class="forms-sample">
                        @csrf
                        <div class="form-group">
                          <label for="nama_penerbit">Penerbit</label>
                          <input type="text" name="nama_penerbit" class="form-control" id="nama_penerbit" placeholder="Nama Penerbit" required value="{{ old('nama_penerbit') }}" autocomplete="nama_penerbit"
              ...
              <div class="float-end mb-3">
                ...
                <a href="/exportpdf_penerbit"><button type="button" class="btn btn-sm btn-info btn-icon-text me-1"> <i class="mdi mdi-printer btn-icon-append"></i>  Cetak PDF  </button></a>
                <a href="/exportexcel_penerbit"> <button type="button" class="btn btn-sm btn-success btn-icon-text me-1"> <i class="mdi mdi-printer btn-icon-append"></i>  Cetak Excel  </button></a>
                      ...
                      @foreach ($penerbits as $index => $penerbit)
                        <tr>
                          ...
                          <td>
                            ...
                            <button type="button" class="btn btn-inverse-primary btn-icon" data-bs-toggle="modal" data-bs-target="#edit{{$penerbit->id}}">
                              <i class="mdi mdi-pencil"></i>
                            </button>
                            
                            <a href="#">
                            <button class="btn btn-inverse-danger btn-icon delete " data-id = "{{$penerbit->id}}" data-penerbit = "{{$penerbit->nama_penerbit}}"> 
                          ...
                          <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                              ...
                              <div class="modal-body px-4">
                                ...
                                <form action="/updatePenerbit/{{$penerbit->id}}" method="POST" enctype="multipart/form-data" class="forms-sample">
                                  @csrf
                                  <div class="form-group">
                                    <label for="nama_penerbit">Penerbit</label>
