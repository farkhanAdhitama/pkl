                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" name="peruntukan" class="form-control" id="peruntukan" placeholder="Peruntukan" required value="{{ old('peruntukan') }}" autocomplete="peruntukan"
                              class="@error('peruntukan') is-invalid @enderror">
                              @error('peruntukan')
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" name="judul_asli" class="form-control" id="judul_asli" placeholder="Judul Asli"  value="{{ old('judul_asli') }}" autocomplete="judul_asli"
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" name="subyek" class="form-control" id="subyek" placeholder="Subyek"  value="{{ old('subyek') }}" autocomplete="subyek"
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" name="penerjemah" class="form-control" id="penerjemah" placeholder="Penerjemah"  value="{{ old('penerjemah') }}" autocomplete="penerjemah"
                              class="@error('penerjemah') is-invalid @enderror">
                              @error('penerjemah')
                                  <sub class="fst-italic text-danger">{{ "$message"  }}</p>
                              @enderror
                            </div>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="number" name="edisi" class="form-control" id="edisi" placeholder="Edisi"  value="{{ old('edisi') }}" autocomplete="edisi"
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="number" name="jilid" class="form-control" id="jilid" placeholder="Jilid"  value="{{ old('jilid') }}" autocomplete="jilid"
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="number" name="cetakan" class="form-control" id="cetakan" placeholder="Cetakan" required  value="{{ old('cetakan') }}" autocomplete="cetakan"
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="number" name="halaman" class="form-control" id="halaman" placeholder="Halaman" required value="{{ old('halaman') }}" autocomplete="halaman"
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            <label class="col-sm-3 col-form-label" for="panjang">Panjang<span class="text-danger">*</span></label>
                            <div class="col-sm-9">
                              <input type="number" name="panjang" class="form-control" id="panjang" placeholder="Panjang (cm)" required  value="{{ old('panjang') }}" autocomplete="panjang"
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="number" name="rak" class="form-control" id="rak" placeholder="Rak"  value="{{ old('rak') }}" autocomplete="rak"
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            <label class="col-sm-3 col-form-label" for="lebar">Lebar<span class="text-danger">*</span></label>
                            <div class="col-sm-9">
                              <input type="number" name="lebar" class="form-control" id="lebar" required placeholder="Lebar (cm)"  value="{{ old('lebar') }}" autocomplete="lebar"
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="number" name="harga" class="form-control" id="harga" placeholder="Harga"  value="{{ old('harga') }}" autocomplete="harga"
