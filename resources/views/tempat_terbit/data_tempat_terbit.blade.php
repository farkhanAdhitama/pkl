    ...
    <div class="row">
        <div class="col-12 grid-margin">
            <div class="float">
                ...
                <button type="button" data-bs-toggle="modal" data-bs-target="#insertTempatTerbit"
                    class="btn btn-sm btn-primary mb-3"><i class="mdi mdi-library-plus mdi-icon"></i>Tambah Tempat
                    Terbit</button>
                <!-- The Insert Modal -->
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body px-4">
                                <form action="/insertTempatTerbit" method="POST" enctype="multipart/form-data"
                                    class="forms-sample">
                                    @csrf
                                    <div class="form-group">
                                        <label for="kota">Tempat Terbit</label>
                                        <input type="text" name="kota" class="form-control" id="kota"
                                            placeholder="Tempat Terbit" required value="{{ old('kota') }}"
                                            autocomplete="kota" class="@error('kota') is-invalid @enderror">
                                        @error('kota')
                ...
                <div class="float-end mb-3">
                    <button type="button" data-bs-toggle="modal" data-bs-target="#import_tempat"
                            ...
                            <div class="modal-content">
                                ...
                                <div class="card m-3 text-center">
                                    <div class="card-body m-3">
                                        ...
                                        <a href="assets/template_import/importtempatterbit_template.xlsx"><button
                                                type="button" class="btn btn-primary text-center">Download</button></a>
                                    </div>
                                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-inverse-info btn-icon"
                                                data-bs-toggle="modal" data-bs-target="#view{{ $tempatterbit->id }}">
                                                <i class="mdi mdi-information-outline"></i>
                                            </button>

                                            <button type="button" class="btn btn-inverse-primary btn-icon"
                                                data-bs-toggle="modal" data-bs-target="#edit{{ $tempatterbit->id }}">
                                                <i class="mdi mdi-pencil"></i>
                                            </button>

                                            <a href="#">
                                                <button class="btn btn-inverse-danger btn-icon delete "
                                                    data-id="{{ $tempatterbit->id }}"
                                                    data-tempatterbit="{{ $tempatterbit->kota }}">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body px-4">
                                                    ...
                                                    <form action="/updateTempatTerbit/{{ $tempatterbit->id }}"
                                                        method="POST" enctype="multipart/form-data"
                                                        class="forms-sample">
                                                        @csrf
                                                        <div class="form-group">
                                                            <label for="kota">Tempat Terbit</label>
                                                            <input value="{{ $tempatterbit->kota }}" type="text"
