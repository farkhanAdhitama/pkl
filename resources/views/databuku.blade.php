...
@section('content')
    ...
    <div class="row">
        <div class="col-12 grid-margin">
            <div class="float">
                <a href="/tambahbuku" type="button" class="btn btn-sm btn-primary mb-3"><i
                        class="mdi mdi-library-plus mdi-icon"></i> Tambah Buku</a>
                <div class="float-end mb-3">
                    <a href="/exportpdf_buku"><button type="button" class="btn btn-sm btn-info btn-icon-text me-1"> <i
                                        ...
                                        <td>
                                            ...
                                            <a href="#">
                                                <button class="btn btn-inverse-danger btn-icon delete "
                                                    data-id="{{ $buku->id }}" data-judul="{{ $buku->judul_buku }}">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-9">
                                                                        <input required value="{{ $buku->peruntukan }}"
                                                                ...
                                                                <div class="form-group row">
                                                                    <label class="col-sm-3 col-form-label"
                                                                        for="judul_buku">Judul Buku<span
                                                                            class="text-danger">*</span></label>
                                                                    <div class="col-sm-9">
                                                                        <input required value="{{ $buku->judul_buku }}"
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-9">
                                                                        <input value="{{ $buku->penerjemah ?? 'N/A' }}"
                                                                ...
                                                                <div class="form-group row">
                                                                    <label class="col-sm-3 col-form-label"
                                                                        for="tahun_terbit">Tahun Terbit<span
                                                                            class="text-danger">*</span></label>
                                                                    <div class="col-sm-9">
                                                                        <input required value="{{ $buku->tahun_terbit }}"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-9">
                                                                        <input value="{{ $buku->edisi }}" type="number"
                                                                            name="edisi" class="form-control"
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-9">
                                                                        <select class="form-control"
                                                                            name="tempat_terbit_id" id="tempat_terbit_id">
                                                                            <option value="">--Piih Tempat Terbit--
                                                                            </option>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-9">
                                                                        <input value="{{ $buku->jilid }}" type="number"
                                                                            name="jilid" class="form-control"
                                                                            id="jilid" placeholder="Jilid"
                                                                            value="{{ old('jilid') }}"
                                                                            autocomplete="jilid"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group row">
                                                                    <label class="col-sm-3 col-form-label"
                                                                        for="rak">Rak</label>
                                                                    <div class="col-sm-9">
                                                                        <input value="{{ $buku->rak }}" type="number"
                                                                            name="rak" class="form-control"
                                                                            id="rak" placeholder="Rak"
                                                                            value="{{ old('rak') }}"
                                                                            autocomplete="rak"
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-9">
                                                                        <input value="{{ $buku->harga }}" type="number"
