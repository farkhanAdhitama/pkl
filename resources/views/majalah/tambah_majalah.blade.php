            ...
            <div class="card-body">
                ...
                <form action="/insertMajalah" method="POST" enctype="multipart/form-data" class="forms-sample">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nama" class="form-control" id="nama" placeholder="Nama Majalah"
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="tanggal_terbit" class="form-control" id="tanggal_terbit"
                            placeholder="DD/MM/YYYY" required value="{{ old('tanggal_terbit') }}"
                            autocomplete="tanggal_terbit" class="@error('tanggal_terbit') is-invalid @enderror">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-9">
                                    ...
                                    <input type="number" name="nomor" class="form-control" id="nomor"
                                        placeholder="Nomor" required value="{{ old('nomor') }}" autocomplete="nomor"
                            ...
                            <div class="form-group row">
                                <div class="col-sm-9">
                                    ...
                                    <input type="number" name="volume" class="form-control" id="volume"
                                        placeholder="Volume" required value="{{ old('volume') }}" autocomplete="volume"
                            ...
                            <div class="form-group row">
                                <div class="col-sm-9">
                                    ...
                                    <input type="text" name="tahun" class="form-control" id="tahun"
                                        placeholder="Tahun" required value="{{ old('tahun') }}" autocomplete="tahun"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="issn" class="form-control" id="issn" placeholder="ISSN" required
                            value="{{ old('issn') }}" autocomplete="issn" class="@error('issn') is-invalid @enderror">
                        @error('issn')
                            <sub class="p fst-italic text-danger">{{ "$message" }}</sub>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" name="topik" class="form-control" id="topik" placeholder="Topik Utama"
                            value="{{ old('topik') }}" autocomplete="topik"
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="jumlah" class="form-control" id="jumlah"
                            placeholder="Jumlah Eksemplar" required value="{{ old('jumlah') }}" autocomplete="jumlah"
