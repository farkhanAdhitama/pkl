            ...
            <div class="card bg-gradient-primary card-img-holder text-white">
                <a style="text-decoration: none; color:white;" href="/databuku">
                    <div class="card-body">
                        ...
                        <h4 class="font-weight-normal mb-3">Jumlah Buku<i
        ...
        <div class="col-md-3 stretch-card grid-margin">
            <div class="card bg-gradient-primary card-img-holder text-white">
                <a style="text-decoration: none; color:white;" href="/dataanggota">
                    <div class="card-body">
                        <img src="assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                        <h4 class="font-weight-normal mb-3">Jumlah Majalah<i
                                class="mdi mdi mdi-book-open-variant mdi-24px float-right"></i>
                        </h4>
        ...
        <div class="col-md-3 stretch-card grid-margin">
            <div class="card bg-gradient-primary card-img-holder text-white">
                <a style="text-decoration: none; color:white;" href="/peminjaman">
                    <div class="card-body">
                        <img src="assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                        <h4 class="font-weight-normal mb-3">Jumlah CD<i class="mdi mdi mdi-disc mdi-24px float-right"></i>
                        </h4>
        ...
        <div class="col-md-3 stretch-card grid-margin">
            <div class="card bg-gradient-primary card-img-holder text-white">
                <a style="text-decoration: none; color:white;" href="/dataanggota">
                    <div class="card-body">
                        <img src="assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                        <h4 class="font-weight-normal mb-3">Jumlah Anggota<i
                                class="mdi mdi-account-multiple mdi-24px float-right"></i>
                        </h4>
                        <h1 class="">{{ $jumlah_anggota }}</h1>
                    </div>
        ...
        <div class="col-md-3 stretch-card grid-margin">
            <div class="card bg-gradient-primary card-img-holder text-white">
                <a style="text-decoration: none; color:white;" href="/peminjaman">
                    <div class="card-body">
                        <img src="assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                        <h4 class="font-weight-normal mb-3">Peminjaman Aktif<i
                                class="mdi mdi-arrow-up-bold-circle mdi-24px float-right"></i>
                        </h4>
        ...
        <div class="col-md-3 stretch-card grid-margin">
            <div class="card bg-gradient-primary card-img-holder text-white">
                <a style="text-decoration: none; color:white;" href="/pengembalian">
                    <div class="card-body">
                        <img src="assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                        <h4 class="font-weight-normal mb-3">Riwayat Pengembalian<i
                                class="mdi mdi-arrow-down-bold-circle mdi-24px float-right"></i>
                        </h4>
