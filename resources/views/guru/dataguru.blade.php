            ...
            <div class="card">
                <div class="card-body">
                    ...
                    if (empty($guru->foto_guru)){?>
                                            <img src="assets/images/foto_guru/person.png" class="me-2"
                                                alt="image">{{ $guru->nama }}
                                            <?php
                    }else{
                  ?>
                                            <img src="assets/images/foto_guru/{{ $guru->foto_guru }}" class="me-2"
                                                alt="image">{{ $guru->nama }}
                                            <?php }?>
                                        </td>
                                        <td>{{ $guru->nik }}</td>
                                        ...
                                        @if ($guru->status == 'Aktif')
                                            <td>
                                                <a href="ubahStatusNonAktifGuru/{{ $guru->id }}"> <label
                                                        style="cursor: pointer;"
                                                        class="badge badge-gradient-primary">{{ $guru->status }}</label></a>
                                            </td>
                                        @else
                                            <td>
                                                <a href="ubahStatusAktifGuru/{{ $guru->id }}"> <label
                                                        style="cursor: pointer;"
                                                        class="badge badge-gradient-danger">{{ $guru->status }}</label></a>
                                            </td>
                                        @endif

                                        <td>
                                            <button type="button" class="btn btn-inverse-info btn-icon"
                                                data-bs-toggle="modal" data-bs-target="#view{{ $guru->id }}">
                                                <i class="mdi mdi-information-outline"></i>
                                            </button>

                                            <button type="button" class="btn btn-inverse-primary btn-icon"
                                                data-bs-toggle="modal" data-bs-target="#edit{{ $guru->id }}">
                                                <i class="mdi mdi-pencil"></i>
                                            </button>

                                            <a href="#">
                                                <button class="btn btn-inverse-danger btn-icon delete "
                                                    data-id="{{ $guru->id }}" data-guru="{{ $guru->nama }}">
                                                ...
                                                <div class="modal-body px-4">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6 ">
                                                            ...
                                                            <?php
                            if (empty($guru->foto_guru)){?>
                                                            <img width="200px" src="assets/images/foto_guru/person.png"
                                                ...
                                                <div class="modal-body px-4">
                                                    ...
                                                    <form action="/updateguru/{{ $guru->id }}" method="POST"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input value="{{ $guru->nama }}" type="text"
                                                            ...
                                                            @error('nama')
                                                                <sub
                                                                    class="p fst-italic text-danger">{{ "$message" }}</sub>
                                                            @enderror
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" name="jabatan" id="jabatan"
                                                                ...
                                                                <option value="{{ $guru->jabatan }}">{{ $guru->jabatan }}
                                                                </option>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input value="{{ $guru->nik }}" type="text"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input value="{{ $guru->email }}" type="email"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input value="{{ $guru->masa_berlaku }}" type="date"
                                                                name="masa_berlaku" class="form-control"
                                                                id="masa_berlaku" placeholder="Angkatan"
                                                                value="{{ old('masa_berlaku') }}"
                                                                autocomplete="masa_berlaku"
