...
class PeminjamanCDSiswaExport implements FromQuery, WithMapping, ShouldAutoSize, WithHeadings
{
    use Exportable;

    public function query()
    {
        return TransaksiSiswa::query()->where('status', 'Dipinjam')->where('jenis', 'cd');
    }
